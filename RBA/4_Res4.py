# -*- coding: utf-8 -*-
"""
Created on Tue Jul  6 12:38:15 2021
...
df = pd.read_csv('./Clean_data/res4.csv', parse_dates=['Date'])
...
cluster_df.to_csv('Result_csv/Cluster_kmeans1_res4.csv', encoding='utf-8', index=True)

##Plots of the features in 2D (2 at a time)
# Temp vs Energy consumption
ax1=cluster_df.plot.scatter(x='Energy_res4',y='AirTemp_C', c='Cluster', colormap="Set1", sharex=False)
...
ax2=cluster_df.plot.scatter(x='Hour',y='Energy_res4',c='Cluster', colormap="Set1", sharex=False)
#Analysis: different than previous residentials; moderate values occur during the day, low values in morning, in evening highest values, visualization of how most power consumption is during mid day hours

#Day of week vs power
ax3=cluster_df.plot.scatter(x='Day of Week',y='Energy_res4',c='Cluster', colormap="Set1", sharex=False)
...
cluster_0
ax.scatter3D(cluster_0['Hour'], cluster_0['Day of Week'],cluster_0['Energy_res4'],c='red');
ax.scatter3D(cluster_1['Hour'], cluster_1['Day of Week'],cluster_1['Energy_res4'],c='blue');
ax.scatter3D(cluster_2['Hour'], cluster_2['Day of Week'],cluster_2['Energy_res4'],c='green');
...
cluster_df2.to_csv('Result_csv/Cluster_kmeans2_res4.csv', encoding='utf-8', index=True)

##Plots of the features in 2D (2 at a time)
# RH vs Energy consumption
ax12=cluster_df2.plot.scatter(x='Energy_res4',y='RelativeHumidity', c='Cluster2', colormap="Set1", sharex=False)
...
ax22=cluster_df2.plot.scatter(x='Energy_res4',y='WindSpeed10m_m/s',c='Cluster2', colormap="Set1", sharex=False)
#there is no clear correlation

#Solar Radiation vs energy consumption
ax32=cluster_df2.plot.scatter(x='GlobalSolarRad_W/m2',y='Energy_res4',c='Cluster2', colormap="Set1", sharex=False)
...
cluster_df3.to_csv('Result_csv/Cluster_kmeans3_res4.csv', encoding='utf-8', index=True)

##Plots of the features in 2D (2 at a time)
# Rain vs Energy consumption
ax13=cluster_df3.plot.scatter(x='Energy_res4',y='PrecipitableWater_kg/m2', c='Cluster3', colormap="Set1", sharex=False)
#no clear correlation, although 1 cluster is clear at low precipitation values

#energy consumption vs snow depth
ax23=cluster_df3.plot.scatter(x='SnowDepth_LWE_cm',y='Energy_res4',c='Cluster3', colormap="Set1", sharex=False)
#no clear correlation

#Wind direction vs energy consumption
ax33=cluster_df3.plot.scatter(x='WindDirection10m',y='Energy_res4',c='Cluster3', colormap="Set1", sharex=False)
...
df_pivot = cluster_df.groupby(by=['date only', 'Hour']).Energy_res4.sum().unstack()
...
df_pivot.to_csv('Result_csv/Cluster_loadcurve_res4.csv', encoding='utf-8', index=True)
fig.savefig('loadcurve_res4.png')


########### Feature Selection ######################################################
#create new column called Energy-1: the energy of the previous hour
df['Energy-1'] = df['Energy_res4'].shift(1)
...
df.to_csv('Result_csv/Feature_Eng_res4.csv', encoding='utf-8', index=True)
...
df_model.to_csv('Result_csv/Model_dataset_res4.csv', encoding='utf-8', index=True)
...
table1.to_csv('Result_csv/reg_table_res4.csv', encoding='utf-8', index=False)

#save errors table
table.to_csv('Result_csv/errors_table_res4.csv', encoding='utf-8', index=False)
...
#save trials table
table3.to_csv('Result_csv/RF_table_res4.csv', encoding='utf-8', index=False)
