# -*- coding: utf-8 -*-
"""
Created on Tue Jul  6 12:55:37 2021
...
df = pd.read_csv('./Clean_data/res9.csv', parse_dates=['Date'])
...
cluster_df.to_csv('Result_csv/Cluster_kmeans1_res9.csv', encoding='utf-8', index=True)

##Plots of the features in 2D (2 at a time)
# Temp vs Energy consumption
ax1=cluster_df.plot.scatter(x='Energy_res9',y='AirTemp_C', c='Cluster', colormap="Set1", sharex=False)
...
ax2=cluster_df.plot.scatter(x='Hour',y='Energy_res9',c='Cluster', colormap="Set1", sharex=False)
...
ax3=cluster_df.plot.scatter(x='Day of Week',y='Energy_res9',c='Cluster', colormap="Set1", sharex=False)
...
cluster_0
ax.scatter3D(cluster_0['Hour'], cluster_0['Day of Week'],cluster_0['Energy_res9'],c='red');
ax.scatter3D(cluster_1['Hour'], cluster_1['Day of Week'],cluster_1['Energy_res9'],c='blue');
ax.scatter3D(cluster_2['Hour'], cluster_2['Day of Week'],cluster_2['Energy_res9'],c='green');
...
cluster_df2.to_csv('Result_csv/Cluster_kmeans2_res9.csv', encoding='utf-8', index=True)

##Plots of the features in 2D (2 at a time)
# RH vs Energy consumption
ax12=cluster_df2.plot.scatter(x='Energy_res9',y='RelativeHumidity', c='Cluster2', colormap="Set1", sharex=False)
...
ax22=cluster_df2.plot.scatter(x='Energy_res9',y='WindSpeed10m_m/s',c='Cluster2', colormap="Set1", sharex=False)
#there is no clear correlation

#Solar Radiation vs energy consumption
ax32=cluster_df2.plot.scatter(x='GlobalSolarRad_W/m2',y='Energy_res9',c='Cluster2', colormap="Set1", sharex=False)
...
cluster_df3.to_csv('Result_csv/Cluster_kmeans3_res9.csv', encoding='utf-8', index=True)

##Plots of the features in 2D (2 at a time)
# Rain vs Energy consumption
ax13=cluster_df3.plot.scatter(x='Energy_res9',y='PrecipitableWater_kg/m2', c='Cluster3', colormap="Set1", sharex=False)
#no clear correlation, although 1 cluster is clear at low precipitation values

#energy consumption vs snow depth
ax23=cluster_df3.plot.scatter(x='SnowDepth_LWE_cm',y='Energy_res9',c='Cluster3', colormap="Set1", sharex=False)
#no clear correlation

#Wind direction vs energy consumption
ax33=cluster_df3.plot.scatter(x='WindDirection10m',y='Energy_res9',c='Cluster3', colormap="Set1", sharex=False)
...
df_pivot = cluster_df.groupby(by=['date only', 'Hour']).Energy_res9.sum().unstack()
...
df_pivot.to_csv('Result_csv/Cluster_loadcurve_res9.csv', encoding='utf-8', index=True)
fig.savefig('loadcurve_res9.png')


########### Feature Selection ######################################################
#create new column called Energy-1: the energy of the previous hour
df['Energy-1'] = df['Energy_res9'].shift(1)
...
df.to_csv('Result_csv/Feature_Eng_res9.csv', encoding='utf-8', index=True)
...
df_model.to_csv('Result_csv/Model_dataset_res9.csv', encoding='utf-8', index=True)
...
table1.to_csv('Result_csv/reg_table_res9.csv', encoding='utf-8', index=False)

#save errors table
table.to_csv('Result_csv/errors_table_res9.csv', encoding='utf-8', index=False)
...
#save trials table
table3.to_csv('Result_csv/RF_table_res9.csv', encoding='utf-8', index=False)
