...
cluster_df.to_csv('Result_csv/Cluster_kmeans1_res7.csv', encoding='utf-8', index=True)
...
cluster_df2.to_csv('Result_csv/Cluster_kmeans2_res7.csv', encoding='utf-8', index=True)
...
cluster_df3.to_csv('Result_csv/Cluster_kmeans3_res7.csv', encoding='utf-8', index=True)
...
df_pivot = cluster_df.groupby(by=['date only', 'Hour']).Energy_res7.sum().unstack()
...
df_pivot.to_csv('Result_csv/Cluster_loadcurve_res7.csv', encoding='utf-8', index=True)
fig.savefig('loadcurve_res7.png')


########### Feature Selection ######################################################
#create new column called Energy-1: the energy of the previous hour
df['Energy-1'] = df['Energy_res7'].shift(1)
...
df.to_csv('Result_csv/Feature_Eng_res7.csv', encoding='utf-8', index=True)
...
df_model.to_csv('Result_csv/Model_dataset_res7.csv', encoding='utf-8', index=True)
...
table1.to_csv('Result_csv/reg_table_res7.csv', encoding='utf-8', index=False)

#save errors table
table.to_csv('Result_csv/errors_table_res7.csv', encoding='utf-8', index=False)
...
#save trials table
table3.to_csv('Result_csv/RF_table_res7.csv', encoding='utf-8', index=False)
