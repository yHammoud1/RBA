# -*- coding: utf-8 -*-
"""
Created on Tue Jul  6 12:51:54 2021
...
df = pd.read_csv('./Clean_data/res8.csv', parse_dates=['Date'])
...
ax1=cluster_df.plot.scatter(x='Energy_res8',y='AirTemp_C', c='Cluster', colormap="Set1", sharex=False)
...
ax2=cluster_df.plot.scatter(x='Hour',y='Energy_res8',c='Cluster', colormap="Set1", sharex=False)
...
ax3=cluster_df.plot.scatter(x='Day of Week',y='Energy_res8',c='Cluster', colormap="Set1", sharex=False)
...
cluster_0
ax.scatter3D(cluster_0['Hour'], cluster_0['Day of Week'],cluster_0['Energy_res8'],c='red');
ax.scatter3D(cluster_1['Hour'], cluster_1['Day of Week'],cluster_1['Energy_res8'],c='blue');
ax.scatter3D(cluster_2['Hour'], cluster_2['Day of Week'],cluster_2['Energy_res8'],c='green');
...
ax12=cluster_df2.plot.scatter(x='Energy_res8',y='RelativeHumidity', c='Cluster2', colormap="Set1", sharex=False)
...
ax22=cluster_df2.plot.scatter(x='Energy_res8',y='WindSpeed10m_m/s',c='Cluster2', colormap="Set1", sharex=False)
#there is no clear correlation

#Solar Radiation vs energy consumption
ax32=cluster_df2.plot.scatter(x='GlobalSolarRad_W/m2',y='Energy_res8',c='Cluster2', colormap="Set1", sharex=False)
...
ax13=cluster_df3.plot.scatter(x='Energy_res8',y='PrecipitableWater_kg/m2', c='Cluster3', colormap="Set1", sharex=False)
#no clear correlation, although 1 cluster is clear at low precipitation values

#energy consumption vs snow depth
ax23=cluster_df3.plot.scatter(x='SnowDepth_LWE_cm',y='Energy_res8',c='Cluster3', colormap="Set1", sharex=False)
#no clear correlation

#Wind direction vs energy consumption
ax33=cluster_df3.plot.scatter(x='WindDirection10m',y='Energy_res8',c='Cluster3', colormap="Set1", sharex=False)
...
df_pivot = cluster_df.groupby(by=['date only', 'Hour']).Energy_res8.sum().unstack()
...
df['Energy-1'] = df['Energy_res8'].shift(1)
